...
import ru.bz.handlingunitsv1.MainActivity;
import ru.bz.handlingunitsv1.R;
import ru.bz.handlingunitsv1.adapters.HandlingUnitsAdapter;
import ru.bz.handlingunitsv1.models.HandlingUnit;
import ru.bz.handlingunitsv1.models.HandlingUnitsDatabase;

public class HandlingUnitsActivity extends AppCompatActivity implements BarcodeReader.BarcodeListener,
...
//                barcodeList.setAdapter(dataAdapter);
                ...
                String newHandlingUnit = event.getBarcodeData();
                database.handlingUnitsDao().insertHandlingUnit(new HandlingUnit(newHandlingUnit, Calendar.getInstance()));
                Toast.makeText(HandlingUnitsActivity.this, newHandlingUnit, Toast.LENGTH_SHORT).show();
                getData();
                adapter.notifyDataSetChanged();
    ...
    public void onFailureEvent(BarcodeFailureEvent barcodeFailureEvent) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                Toast.makeText(HandlingUnitsActivity.this, "No data", Toast.LENGTH_SHORT).show();
            }
        });
    }
